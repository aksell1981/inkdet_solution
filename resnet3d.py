...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.bn1(x)
        x = self.relu(x)
        x = self.maxpool(x)#;print('x:',x.shape)

        x1 = self.layer1(x)#;print('x1:',x1.shape)
        x2 = self.layer2(x1)#;print('x2:',x2.shape)
        x3 = self.layer3(x2)#;print('x3:',x3.shape)
        x4 = self.layer4(x3)#;print('x4:',x4.shape)
